...
<jsp:setProperty name="form" property="formURL" value="borrow_list.jsp" />
...
%>
      <form name="form1" action="borrow_list.jsp?<%= queryParameter%>" method="post">
        <center>
          <p>Limiting options: 
...
%>
      <form name="form2" method="post" action="borrow_list.jsp?<%= queryParameter%>">
...
%>
        <form name="form2" method="post" action="borrow_list.jsp">
        <i>* click on Borrower ID to sent email for notice</i><br>

          
        <table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
          <tr> 
            <th width="18%" bgcolor="#D3DCE3">Borrower ID<a href=borrow_list.jsp?&queryOrderField=borrowerID&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("borrowerID") && queryOrderType.equals("ASC")) 
				...
				%>
              </a> <a href=borrow_list.jsp?&queryOrderField=borrowerID&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="20%" bgcolor="#D3DCE3">Item Call No<a href=borrow_list.jsp?&queryOrderField=itemCallNumber&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("itemCallNumber") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=borrow_list.jsp?&queryOrderField=itemCallNumber&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="18%" bgcolor="#D3DCE3">Borrow Date<a href=../admin/borrow_list.jsp?&queryOrderField=borrowDate&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("borrowDate") && queryOrderType.equals("ASC")) 
					...
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=borrow_list.jsp?&queryOrderField=borrowDate&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="15%" bgcolor="#D3DCE3">Due Date<a href=borrow_list.jsp?&queryOrderField=dueDate&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("dueDate") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=borrow_list.jsp?&queryOrderField=dueDate&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="17%" bgcolor="#D3DCE3">Return Date<a href=borrow_list.jsp?&queryOrderField=returnDate&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("returnDate") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=borrow_list.jsp?&queryOrderField=returnDate&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="12%" bgcolor="#D3DCE3">Status<a href=borrow_list.jsp?&queryOrderField=borrowStatus&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("borrowStatus") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=borrow_list.jsp?&queryOrderField=borrowStatus&queryOrderType=DESC&<%= queryParameter%>> 
...
<%
	...
	String queryCount = "SELECT count(*) FROM borrowrec" + queryCondition + queryOrder;
   	try {  
	...
	// Get the request record result from search query
		query = "SELECT * FROM borrowrec" + queryCondition;
  		try {  
      		Connection connection = connectionPool.getConnection();
...
%>
    	...
    	if (myResultSet != null){
			...
			try{
				...
				System.err.println("borrow_list.jsp Error connecting: " +sqle);		
			}
		} 
%>
        </table>
