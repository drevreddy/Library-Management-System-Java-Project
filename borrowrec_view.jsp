...
<jsp:setProperty name="form" property="formURL" value="borrowrec_view.jsp" />
		...
		if (borrowRecNumber != null) {
    		...
    		if (myResultSet != null){
				try{
					...
					System.err.println("borrowrec_view.jsp Error connecting: " +sqle);		
				}
			}
		} 

%>  
		<%@ include file="borrowrec_form_view.jsp" %>
      <br>
		</td>
  </tr>
</table>
