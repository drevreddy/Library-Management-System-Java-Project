...
<jsp:setProperty name="form" property="formURL" value="my_borrow_list.jsp" />
<%  response.setHeader("Cache-Control", "no-cache");
	response.setHeader("Pragma", "no-cahce");
// 	URLcurrent = "my_borrow_list.jsp";
    	...
    	if (myResultSet != null){
			...
			try{
				while(myResultSet.next()) {
					String iCaNo=myResultSet.getString("itemCallNumber");
	    			if (rowCount % 2 == 0)
	       				out.println ("<tr bgcolor=#CCCCCC align=left>");
					else 
					out.println ("<tr bgcolor=#DDDDDD align=left>");
					out.println("<TD><a href='libraryitem_view.jsp?itemCallNumber=" +iCaNo+"'>" +iCaNo+"</a>");
				...
				System.err.println("my_borrow_list.jsp Error connecting: " +sqle);		
			}
		} 
%>   </table>
        </form> 
