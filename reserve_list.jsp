...
<jsp:setProperty name="form" property="formURL" value="reserve_list.jsp" />
...
%>
      <form name="form1" action="reserve_list.jsp?<%= queryParameter%>" method="post">
        <center>
          <p>Limiting options: 
...
%>
      <form name="form2" method="post" action="reserve_list.jsp?<%= queryParameter%>">
...
%>
      ...
      <form name="form2" method="post" action="./formprocess">
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
          <tr>             
            <td width="4%"></td>
            <th width="18%" bgcolor="#D3DCE3">Reserver ID<a href=reserve_list.jsp?&queryOrderField=reserverID&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("reserverID") && queryOrderType.equals("ASC")) 
				...
				%>
              </a> <a href=reserve_list.jsp?&queryOrderField=reserverID&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="14%" bgcolor="#D3DCE3">Item Call No<a href=reserve_list.jsp?&queryOrderField=itemCallNumber&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("itemCallNumber") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=reserve_list.jsp?&queryOrderField=itemCallNumber&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="18%" bgcolor="#D3DCE3">Reserve Date<a href=reserve_list.jsp?&queryOrderField=reserveDate&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("reserveDate") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=reserve_list.jsp?&queryOrderField=reserveDate&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="18%" bgcolor="#D3DCE3">Cancel Date<a href=reserve_list.jsp?&queryOrderField=reserveCancelDate&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("reserveCancelDate") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=reserve_list.jsp?&queryOrderField=reserveCancelDate&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="19%" bgcolor="#D3DCE3">Inform Date<a href=reserve_list.jsp?&queryOrderField=reserveInformDate&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("reserveInformDate") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=reserve_list.jsp?&queryOrderField=reserveInformDate&queryOrderType=DESC&<%= queryParameter%>> 
            ...
            <th width="13%" bgcolor="#D3DCE3">Status<a href=reserve_list.jsp?&queryOrderField=reserveStatus&queryOrderType=ASC&<%= queryParameter%>><br>
              <% if(queryOrderField.equals("reserveStatus") && queryOrderType.equals("ASC")) 
					out.println("<img src='icon_sort_up_on.gif' width='20' height='7' border='0'>");
					else
					out.println("<img src='icon_sort_up_off.gif' width='20' height='7' border='0'>");
				%>
              </a> <a href=reserve_list.jsp?&queryOrderField=reserveStatus&queryOrderType=DESC&<%= queryParameter%>> 
...
%>
    	...
    	if (myResultSet != null){
			...
			try{
				...
				System.err.println("reserv_list.jsp Error connecting: " +sqle);		
			}
		} 
%>
        </table>
