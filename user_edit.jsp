...
<jsp:setProperty name="form" property="formURL" value="user_edit.jsp" />
<% user.resetVariable(); %>
<% 
	...
	query = ("SELECT * FROM libuser WHERE userRecNumber = " +userRecNumber); 
    	try {  
    	...
    	if (myResultSet != null){
			try{
				...
				System.err.println("user_edit.jsp Error connecting: " +sqle);		
			}
		} 
%>  
