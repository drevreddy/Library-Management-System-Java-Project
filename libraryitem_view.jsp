...
<% 	URLcurrent = "libraryitem_view.jsp";
...
<jsp:setProperty name="form" property="formURL" value="libraryitem_view.jsp" />
<% libraryitem.resetVariable(); %>
    	...
    	if (myResultSet != null){
			try{
				...
				System.err.println("libraritem_view.jsp Error connecting: " +sqle);		
			}
		} 
%>  
		<%@ include file="libraryitem_form_view.jsp" %>
      <br>
		</td>
  </tr>
</table>
