...
<%	} else { %>
  <form name=login action="./login" method="post">
    <p><img src="header.gif" width="538" height="85"></p>
    <table width=225 border=0 cellpadding=3>
      <tr>
        <td colspan=2>
          <center>
            <font size="+2"><b><img src="login.gif" width="85" height="115">Login</b></font> 
          </center>
        </td>
      </tr>
      <tr>
...
<p align="center"><font size="+2"><img src="small_logo.gif" width="37" height="46"></font><font face="arial, helvetica" size="-1"></font> </td>
  </tr>
</table>
