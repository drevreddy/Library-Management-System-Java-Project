  ...
  <tr> 
    <td> 
      <table cellspacing=0 cellpadding=0 width=176 border=0>
        <tbody> 
        <tr> 
          <td class=flyoutHeading><a href="about.jsp"></a></td>
        </tr>
        <tr> 
          <td class=flyoutHeading><a href="faq.jsp"></a></td>
        </tr>
        </tbody> 
      </table>
      <table cellspacing=0 cellpadding=0 width=176 border=0>
        ...
        <tr> 
          <td class=flyoutLink> 
            <FORM name=helpForm  ACTION="javascript:" METHOD="POST">
              	<INPUT type="hidden" NAME="url" value="help.jsp" >
              ...
              <a href="#" onclick="customize(this.helpForm)"> </a>
</form>
          </td>
        </tr>
        </tbody> 
