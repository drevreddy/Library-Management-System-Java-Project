...
// 	URLcurrent = "reservation_add.jsp";
...
<jsp:setProperty name="form" property="formURL" value="./reservation_add.jsp" />
...
if (refURL!=null){
	if((refURL.indexOf("reservation_add.jsp") < 0) || (dbprocess.isProcessComplete())) {
		...
		if( !(itemCallNumber.equals("")) ) {
    		...
    		if (myResultSet != null){
				try{
					...
					System.err.println("reservation_add.jsp Error connecting: " +sqle);		
				}
			}
			if(itemCallNumber.equals(""))
          ...
          <td> 
            <table width="23%" border="0" align="center">
              <tr>
                ...
                <td width="17%"> 
                  <form name="form4" method="post" action="./reservation_add1.jsp">
                    <% for(int i=0; i<itemsReserved.size(); i++){
					itemCallNumberInList = (String[])itemsReserved.elementAt(i);
