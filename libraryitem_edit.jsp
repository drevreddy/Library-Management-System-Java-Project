...
<% 	URLcurrent = "libraryitem_list.jsp";
...
<jsp:setProperty name="form" property="formURL" value="libraryitem_edit.jsp" />
	...
	query = ("SELECT * FROM libraryitem WHERE itemRecNumber = " +itemRecNumber); 
    	...
    	if (myResultSet != null){
			try{
				...
				System.err.println("libraryitem_edit.jsp Error connecting: " +sqle);		
			}
		} 
%>  
		<%@ include file="libraryitem_form.jsp" %>
      <br>
		</td>
  </tr>
</table>
