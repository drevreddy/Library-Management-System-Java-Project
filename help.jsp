...
<hr>
<% } else if (refURL.equals("login.jsp")) {
%>
<center>
  <b>Login</b> 
</center>
...
<hr>
<% } else if (refURL.equals("login_invalid.jsp")) {
%>
<center>
  <b>Invalid Login</b> 
</center>
...
<hr>
<% } else if (refURL.equals("faq_member_policy.jsp")) {
%>
<center>
...
<HR>
<% } else if (refURL.equals("faq_library_open_hours.jsp")) {
%>
<center>
  <b>FAQ: 
...
<HR>
<% } else if (refURL.equals("faq_reservation_item.jsp")) {
%>
<center>
...
<hr>
<% } else if (refURL.equals("faq_apply_membership.jsp")) {
%>
<center>
</center>
<center>
...
<hr>
<% } else if (refURL.equals("about.jsp")) {
%>
<center>
  <b>About</b>
</center>
...
<hr>
<% } else if (refURL.equals("search_libraryitem.jsp")) {
%>
<center>
...
<table width="70%" border="1">
  <tr> 
    <td width="50%"><img src="icon_sort_down_off.gif" width="10" height="7"> 
      Descend order</td>
    <td><img src="icon_sort_up_off.gif" width="20" height="7"> 
      Ascend order</td>
  </tr>
</table>
<br>
...
<BR>
<hr>
<% } else if (refURL.equals("user_list.jsp")) {
%>
<center>
  <b>User List</b>
</center>
...
<hr>
<% } else if (refURL.equals("libraryitem_list.jsp")) {
%>
<center>
...
<hr>
<% } else if (refURL.equals("borrow_list.jsp")) {
%>
<center>
  <b>Borrow List</b>
</center>
...
<br>
<hr>
<% } else if (refURL.equals("reserve_list.jsp")) {
%>
<center>
  <b>Reserve List</b>
</center>
...
<hr>
<% } else if (refURL.equals("penalty_list.jsp")) {
%>
<center>
  <b>Penalty List</b>
</center>
...
<hr>
<% } else if (refURL.equals("borrow.jsp")) {
%>
<center>
  <b>Borrow</b>
</center>
...
<hr>
<% } else if (refURL.equals("return.jsp")) {
%>
<center>
  <b>Return</b>
</center>
...
<hr>
<% } else if(refURL.equals("dbprocess_result.jsp")) {
%>
<center>
  <b>Database Result </b>
</center>
...
<hr>
<% } else if (refURL.equals("myaccount.jsp")) {
%>
<center>
  <b>My Account </b>
</center>
...
<hr>
<% } else if (refURL.equals("my_borrow_list.jsp")) {
%>
<center>
  <b>My Borrow List </b> 
</center>
...
<hr>
<% } else if (refURL.equals("reservation_add.jsp")){
%>
<center>
  <b>Add Reservation</b>
</center>
...
<hr>
<% } else if (refURL.equals("my_reservation_list.jsp")) {
%>
<center>
  <b>My Reservation</b>
</center>
...
<hr>
<% } else if (refURL.equals("user_add.jsp")) {
%>
<center>
  <b>Add User</b>
</center>
...
<hr>
<% } else if (refURL.equals("user_edit.jsp")) {
%>
<center>
  <b>Edit User</b>
</center>
...
<hr>
<% } else if (refURL.equals("libraryitem_add.jsp")) {
%>
<center>
...
<hr>
<% } else if (refURL.equals("libraryitem_edit.jsp")) {
%>
<center>
...
<hr>
<% } else if (refURL.equals("libraryitem_view.jsp")) {
%>
<center>
...
<hr>
<% } else if (refURL.equals("songjing.jsp")) {
%>
<center>
  <b>About Me</b>
</center>
...
<hr>
<% } else if (refURL.equals("contact.jsp")) {
%>
<center>
  <b>Contact me</b>
</center>
...
%>
<center>
  <a href="#" onclick="window.close()"><img src="22_btn_x.gif" width="20" height="17"></a> 
  <a href="#" onclick="window.close()"><img src="22_btn_close.gif" width="50" height="17"></a> 
</center>
