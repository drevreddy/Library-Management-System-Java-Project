...
function loadPage(nthTrack,nthBorder)
{
	...
	else
	{
		...
		{
			document.all('HPFrameHLTab3').src = "collapse.gif";
			document.all('HPFrameDLTab3').src = "collapse.gif";
		}
	}
}
...
function showHideContent(id,bOn)
{
	...
	if (bOn == false)
	{
		...
		oImage.src = "expand" + (bMO? "_mo.gif" : ".gif");
	}
	else
	{
		oContent.style.display = "";
		oImage.src = "collapse" + (bMO? "_mo.gif" : ".gif");
	}
...
function setBorder(id,bOn)
{
	...
	if (bOn)
	{
		...
		oTab.bgColor = "#3366CC";
		oTab1.src    = "curve_mo.gif";
		oTab2.color  = "#FFFFFF";
		if (oBorder.style.display == "none")
			oTab3.src = "expand_mo.gif";
		else
			oTab3.src = "collapse_mo.gif";
	}
	else
	{
		...
		oTab2.color  = "#336699";
		if (oBorder.style.display == "none")
			oTab3.src = "expand.gif";
		else
			oTab3.src = "collapse.gif";
	}
}
